 ...
 *     tags:
 *       - Quran
 *     description: menampilkan Al-Quran berdasarkan surat dan ayat
 *     produces:
 *       - application/json
 *     parameters:
 *       - name: surat
 *         description: surat pada Al-Quran dalam bentuk nomor
 *         in: path
 *         required: true
 *         type: number
 *       - name: ayat
 *         description: ayat pada surat yang dipilih
 *         in: path
 *         required: true
 *         type: number
 *     responses:
 *       200:
 *         description: surat dan ayat Al-Quran ditemukan
 *         schema:
 ...
 *     tags:
 *       - Quran
 *     description: menampilkan surat dan jumlah ayat Al-Quran
 *     produces:
 *       - application/json
 *     responses:
 *       200:
